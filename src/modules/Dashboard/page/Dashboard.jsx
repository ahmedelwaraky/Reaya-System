...
export default function Dashboard() {
  ...
  /* ── AI Insights ─────────────────────────── */
  const insights = [
    { id: 1, titleKey: "insights.erOverload",       descKey: "insights.erOverloadDesc",       variant: "danger"  },
    { id: 2, titleKey: "insights.doctorBalance",    descKey: "insights.doctorBalanceDesc",    variant: "warning" },
    { id: 3, titleKey: "insights.visitIncrease",    descKey: "insights.visitIncreaseDesc",    variant: "info"    },
    { id: 4, titleKey: "insights.nurseShortage",    descKey: "insights.nurseShortageDesc",    variant: "danger"  },
    { id: 5, titleKey: "insights.eveningClinic",    descKey: "insights.eveningClinicDesc",    variant: "warning" },
  ];

  /* ── Smart Notifications ─────────────────── */
  const notifications = [
    { id: 1, titleKey: "notif.criticalPatient",  descKey: "notif.criticalPatientDesc",  timeKey: "notif.now",     variant: "danger"  },
    { id: 2, titleKey: "notif.medicineShortage", descKey: "notif.medicineShortageDesc", timeKey: "notif.10mins",  variant: "warning" },
    { id: 3, titleKey: "notif.lateAppointment",  descKey: "notif.lateAppointmentDesc",  timeKey: "notif.30mins",  variant: "info"    },
    { id: 4, titleKey: "notif.insuranceUpdate",  descKey: "notif.insuranceUpdateDesc",  timeKey: "notif.1hour",   variant: "neutral" },
  ];

  /* ── Hospital Live Map ───────────────────── */
  const floors = [
    {
      id: 1, labelKey: "liveMap.floor0",
      rooms: [
  ...
  /* ── Smart Queue ─────────────────────────── */
  const queue = [
    { id: 1, rank: 1, name: "محمد العمري",   code: "E-001", dept: "الطوارئ", type: "طوارئ",  wait: "0 دقيقة",  priority: "critical", priorityLabel: "حرج"    },
    { id: 2, rank: 2, name: "سارة المالكي",  code: "E-002", dept: "الطوارئ", type: "طوارئ",  wait: "5 دقائق",  priority: "urgent",   priorityLabel: "عاجل"   },
    { id: 3, rank: 3, name: "أحمد الدوسري",  code: "A-015", dept: "القلب",   type: "موعد",   wait: "12 دقيقة", priority: "normal",   priorityLabel: "عادي"   },
    { id: 4, rank: 4, name: "هند الحربي",    code: "A-016", dept: "العظام",  type: "موعد",   wait: "18 دقيقة", priority: "normal",   priorityLabel: "عادي"   },
    { id: 5, rank: 5, name: "يوسف المطيري",  code: "R-008", dept: "الباطنية",type: "مراجعة", wait: "25 دقيقة", priority: "low",      priorityLabel: "منخفض"  },
    { id: 6, rank: 6, name: "نورة الغنزي",   code: "A-017", dept: "الأطفال", type: "موعد",   wait: "30 دقيقة", priority: "normal",   priorityLabel: "عادي"   },
    { id: 7, rank: 7, name: "فهد القرني",    code: "R-009", dept: "الجلدية", type: "مراجعة", wait: "35 دقيقة", priority: "low",      priorityLabel: "منخفض"  },
  ];
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-[13px] text-[var(--c-sub)] mt-0.5">{t("overview")}</p>
      </div>
