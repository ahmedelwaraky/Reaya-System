    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <StatCard
          ...
          value={s.monthlyRevenue.value}
          change={s.monthlyRevenue.change}
          icon={DollarSign}
        />
        <StatCard
          label={t("stats.expenses")}
          value={s.expenses.value}
          change={s.expenses.change}
          icon={TrendingDown}
        />
        <StatCard
          label={t("stats.netProfit")}
          value={s.netProfit.value}
          change={s.netProfit.change}
          icon={TrendingUp}
        />
        <StatCard
          label={t("stats.collectionRate")}
          value={s.collectionRate.value}
          change={s.collectionRate.change}
          icon={BadgePercent}
        />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <StatCard
          ...
          value={s.totalInvoices.value}
          change={s.totalInvoices.change}
          icon={FileText}
        />
        <StatCard
          label={t("stats.paid")}
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-[var(--c-border)]">
                ...
                <th className="py-2 px-3 text-start font-semibold text-[var(--c-sub)]">
                  {t("topPatients.invoices")}
                </th>
                <th className="py-2 px-3 text-start font-semibold text-[var(--c-sub)]">
                  {t("topPatients.total")}
                </th>
                <th className="py-2 px-3 text-start font-semibold text-[var(--c-sub)]">
                  {t("topPatients.status")}
                </th>
              </tr>
            </thead>
            <tbody>
