  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar
                  dataKey="sick"
                  stackId="a"
                  fill={STACK_COLORS.sick}
                  maxBarSize={36}
                />
                <Bar
                  dataKey="emergency"
                  stackId="a"
                  fill={STACK_COLORS.emergency}
                  maxBarSize={36}
                />
                <Bar
                  dataKey="conference"
                  stackId="a"
                  fill={STACK_COLORS.conference}
                  radius={[6, 6, 0, 0]}
                  maxBarSize={36}
                />
              </BarChart>
        ...
        <DonutChartCard title={t("charts.byType")} data={LEAVES_BY_TYPE} />
      </div>
